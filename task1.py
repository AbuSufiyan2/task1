...
def choose_word():
    words = ['python',  'Hangaman', 'challenge', 'programming', 'development']
...
def hangman():
    ...
    while incorrect_attempts < max_attempts:
        print("\nWorld to guess: "+ display_word(word, guessed_letters))
        ...
        if incorrect_attempts == max_attempts:
            print(f"\nSorry, you're out of attemtps. The word was: {word}")
